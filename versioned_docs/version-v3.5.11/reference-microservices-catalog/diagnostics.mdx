---
title: Diagnostics Microservice - Catalog Reference
description: Reference for the Diagnostics Microservice. Troubleshoot ioFog functionality, connectivity, and system health.
keywords: [diagnostics microservice, troubleshooting, ioFog, edge diagnostics, system container, system health]
---
