# What's New in PoT?
- [Dynamic Microservice Routing](../reference-potctl/reference-agent.mdx) , is now available with msRoutes.pubtags and msRoutes.subtags definitions on Microservice or Application YAMLs.
- [Agent as a Container](../reference-potctl/reference-agent.mdx) , option added for Remote Agents and Remote ContorlPlane Agents.
- [Agent Router SSL](../reference-potctl/reference-agent.mdx) , a new config parameter added for ioFog Agents Router configuration.
...
[Find out more](../reference-potctl/reference-application)!
...
[Find out more](../reference-potctl/reference-agent)!
