...
You can also find all available commands, and a detailled documentation of their usage on [our github repository](https://github.com/Datasance/potctl/blob/main/docs/md/potctl.mdx).
