---
title: NATS Server Microservice - Catalog Reference
description: Deploying NATS server or leaf nodes on edge devices using Datasance PoT. YAML examples for NATS configuration and clustering.
keywords: [nats server, nats leaf node, edge messaging, datasance pot, microservice, nats configuration, message broker]
---
