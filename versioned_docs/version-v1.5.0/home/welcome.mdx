...
| ---------------- | ---------------- | ---------------- | ------------------ | ----------------- |
| Eclipse ioFog    | iofogctl         | v3.0.0           | potctl             | v1.5.0            |
| Eclipse ioFog    | Agent            | v3.0.1           | Agent              | v3.6.0           |
| CNCF Containerd  | Runwasi          | v0.7.0           | Runwasi            | v0.7.0            |
| Eclipse ioFog    | Controller       | v3.0.4           | Controller         | v3.6.0            |
| Eclipse ioFog    | ECN-Viewer       | v3.0.0           | ECN-Viewer         | v1.3.0           |
| Eclipse ioFog    | Router           | v3.0.0           | Router             | v3.6.0            |
| RedHat Skupper   | Skupper-Router   | v3.4.0           | Router             | v3.6.0            |
| Eclipse ioFog    | Operator         | v3.2.0           | Operator           | v3.6.0          |
| Eclipse ioFog    | HAL              | v1.0.0           | HAL                | v1.1.0            |
| Eclipse ioFog    | RESTBLUE         | v0.1             | RESTBLUE           | v1.0.0            |
| Eclipse ioFog    | iofog-go-sdk     | v3.3.0           | iofog-go-sdk       | v3.6.0           |
