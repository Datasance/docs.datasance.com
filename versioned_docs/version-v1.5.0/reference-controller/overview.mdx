---
title: Controller Overview - Reference
description: Overview of the Controller component in Datasance PoT. Learn how it orchestrates agents and microservices in an Edge Compute Network.
keywords: [controller overview, edge orchestration, ecn management, datasance pot, edge controller, microservice orchestration]
---
