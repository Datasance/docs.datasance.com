---
title: Application Template YAML Specification - potctl Reference
description: YAML specification for Datasance PoT Application Templates. Define reusable application configurations with templated variables for scalable edge deployments.
keywords: [application template, potctl, yaml reference, datasance pot, edge deployment template, reusable application]
---
