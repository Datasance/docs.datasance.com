...
spec:
  ...
  images:
   # pullSecret:  # set the K8S pull secret name
    operator: ghcr.io/datasance/operator:3.6.0
...
spec:
  ...
  - name: remote-1
    ...
    #     args:
    #       - ghcr.io/datasance/controller:3.6.0
    #   uninstall:
    ...
    systemAgent: # systemAgent configuration that runs alongside with Controller on the same host
      ...
      #   # version: 3.6.0# set the version for Agent package
      #   container:
  ...
  #   container:
  #     image: emirhandurmus/controller:3.6.0
  # systemMicroservices:
  #   router:
  #     x86: ghcr.io/datasance/router:3.6.0
  #     arm: ghcr.io/datasance/router:3.6.0
...
spec:
  ...
  controller:
    container:
      image: ghcr.io/datasance/controller:3.6.0
```
