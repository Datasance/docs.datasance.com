...
| Field              | Description                                                                                                                                                                                                                                                                     |
| ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| apiVersion         | Schema version. Use `datasance.com/v3`. |
...
spec:
  ...
  controller:
    container:
      image: ghcr.io/datasance/controller:3.7.1
```
...
To learn more about the `AgentConfig` kind, please see [Agent Configuration](../agent-management/agent-configuration) and [Agent YAML Specification](reference-agent).
