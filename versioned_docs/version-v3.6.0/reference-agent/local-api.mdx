---
title: Agent Local API Reference
description: API reference for the Agent Local API. Interact with edge agents programmatically via REST and WebSockets for microservices.
keywords: [local api, agent api, edge websocket, datasance pot, microservice communication, rest api, edge messaging]
---
