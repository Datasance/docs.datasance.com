...
```yaml
operator:
  image: ghcr.io/datasance/operator:3.6.0
controlplane:
  spec:
...
pot-operator  1         Tue Dec  8 21:34:42 2025  DEPLOYED  pot-3.6.0    3.6.0        pot
```
...
--set operator.image=ghcr.io/datasance/operator:3.6.0
...
```bash
--set controlplane.spec.images.controller=ghcr.io/datasance/controller:3.6.0
--set controlplane.spec.images.routerAdaptor=ghcr.io/datasance/router-adaptor:3.6.0
--set controlplane.spec.images.router=ghcr.io/datasance/router:3.6.0
...
controlplane:
  ...
  spec:
    ...
    images:
      # pullSecret: ""
      controller: "ghcr.io/datasance/controller:3.6.0"
      routerAdaptor: "ghcr.io/datasance/router-adaptor:3.6.0"
...
```bash
helm upgrade pot-operator datasance/pot -n pot -f pot-operator-values.yaml
```
