...
<p>A complete reference of AgentConfig kind is available in the relevant section in <a  href="../yaml-references/reference-agent">potctl reference</a> documentation.</p>
