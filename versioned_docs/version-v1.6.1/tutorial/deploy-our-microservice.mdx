...
This yaml file has been used to describe to `potctl` what our set of microservices (application) should look like, and how they are configured. You can find a complete description of the YAML format [here](../yaml-references/reference-application), but for now let's focus on the main parts.
...
Find the complete yaml description [here](../yaml-references/reference-application)
