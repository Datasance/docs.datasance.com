...
Specifications of the ioFog platform YAML types can be found [here](../yaml-references/reference-control-plane).

Specifications of the ioFog application YAML types can be found [here](../yaml-references/reference-application).
...
:::info[Next steps?]
  <ul>
    ...
    <li><a href="../yaml-references/reference-kinds">potctl reference.</a></li>
  </ul>
:::
