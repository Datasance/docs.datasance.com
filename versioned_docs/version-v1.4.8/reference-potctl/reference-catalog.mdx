...
description: Reference for Catalog Item YAML specification. Manage microservice catalogs and Docker image registries in Datasance PoT.
keywords: [catalog item, microservice catalog, docker registry, potctl, yaml reference, datasance pot, edge software catalog]
---
