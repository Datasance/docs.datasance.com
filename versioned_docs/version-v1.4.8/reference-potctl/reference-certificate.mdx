---
title: Certificate & CA YAML Specification - potctl Reference
description: YAML reference for managing Certificates and Certificate Authorities in Datasance PoT. Secure your edge microservices with TLS/SSL.
keywords: [certificate, certificate authority, ca, tls, security, potctl, yaml reference, datasance pot, edge security]
---
