...
:::info[We use YAML to define ioFog resources]
  <p>The following procedures will define resources in YAML for potctl to consume. Specification of those YAML resources can be found <a href= "/docs/yaml-references/reference-control-plane">here</a>.</p>
:::
