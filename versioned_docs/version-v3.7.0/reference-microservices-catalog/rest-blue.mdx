...
> You can use the `hostNetworkMode` and  `isPrivileged` of the [microservice yaml definition](../yaml-references/reference-application) to grant root access to the host to your container
