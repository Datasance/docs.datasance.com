---
title: Legacy Agent CLI Usage - Reference
description: Legacy CLI command reference for iofog-agent. Manage edge agents directly via command line for legacy deployments.
keywords: [agent cli, iofog-agent, legacy cli, datasance pot, edge management, command line interface]
---
