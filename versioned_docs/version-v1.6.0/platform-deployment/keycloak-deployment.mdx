...
:::warning
The Keycloak Operator will watch the namespace where it is installed. You may optionally select a namespace with the `--namespace or -n` option.
::: 
...
<p>We recommended going through the <a href="../platform-deployment/database">Database Installation Guide</a> before continuing on here.</p>
::: 
...
spec:
  instances: 1
  image: ghcr.io/datasance/keycloak:25.0.0
