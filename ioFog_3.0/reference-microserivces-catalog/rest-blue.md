...
> You can use the `rootHostAccess` field of the [microservice yaml definition](../ioFog_3.0/reference-iofogctl/reference-application) to grant root access to the host to your container
