---
title: Proxus IIoT Platform - Catalog Reference
description: Proxus IIoT Platform reference. Industrial IoT data management, edge computing, and real-time analytics for manufacturing and automation.
keywords: [proxus iiot, industrial iot, edge analytics, datasance pot, opc ua, modbus, edge computing, industrial automation]
---
...
spec:
    ...
    application:
            ...
            leafNodes:
              remotes:
                ...
                tls:
                  ...
                  TlsKey: "{{tls-key}}"
        images:
          amd64: ghcr.io/datasance/nats:latest
          arm64: ghcr.io/datasance/nats:latest
          registry: remote
        container:
      ...
      - name: "{{gateway-name}}-proxus"
        ...
        config: {}
        images:
          amd64: proxusplatform/proxus-server:1.1.1.0-amd64
          arm64: proxusplatform/proxus-server:1.1.1.0-arm64
          registry: remote
        container:
          runAsUser: "0"
          volumes:
