...
:::warning[Prepare your Keycloak Realms for Datasance PoT]
  <p>We recommened going through the <a href="../platform-iam/introduction">Keycloak Installation Guide</a> before continuing on here. In this guide we also assume we are up and running with potctl, if that is not the case download and be at least marginally familiar with <a href="../potctl/download">potctl</a>.</p>
:::
