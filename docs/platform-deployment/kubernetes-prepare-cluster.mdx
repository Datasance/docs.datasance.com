...
:::tip[Where to go from here?]
  <p>Now that we have the cluster up, we need to deploy the Control Plane onto the cluster. To use potctl, go to <a href="../platform-deployment/kubernetes-potctl">Kubernetes - Deploy Control Plane Using potctl</a>.</p>
:::
