...
:::info[Don't see your language?]
  ...
  <p>Under the hood, the SDK uses the <a href="/v3.7.3/reference-agent/local-api">Agent Local API</a> (legacy) or EdgeletAPI on v3.8 nodes, which, while more low-level, is considered a public API you can call directly too.</p>
