...
* [iofogctl](/iofogctl/cli/iofogctl) - * [iofogctl configure auth-group](/iofogctl/cli/iofogctl_configure_auth-group)	 - Update an embedded auth group
