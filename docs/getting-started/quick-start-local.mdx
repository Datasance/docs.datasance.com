...
The Windows binary can be downloaded from [Datasance Packages](https://github.com/Datasance/potctl/releases/download/v1.3.5/potctl.exe).
...
spec:
  ...
  controller:
    container:
      image: ghcr.io/datasance/controller:3.4.8
---
apiVersion: datasance.com/v3
kind: LocalAgent
metadata:
...
dc7568ad1708        ghcr.io/datasance/controller:3.4.8         "node /usr/local/lib…"   16 minutes ago      Up 16 minutes       0.0.0.0:51121->51121/tcp, 0.0.0.0:8008->80/tcp                 iofog-controller
```
