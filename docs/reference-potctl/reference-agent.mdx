...
spec:
  ...
  ssh:
    ...
    port: 22
  package:
    version: 3.3.2 # provide Agent package version if you would like to deploy Agent as a deb or rpm package
    container: 
      image: ghcri.io/datasance/agent:3.3.2  # provide image in the case you would like to deploy Agent as a container
  config:
...
| bluetoothEnabled             | Boolean. Set on/off for the [bluetooth service](../reference-microservices-catalog/rest-blue). If ON, this will install the restblue microservice                                                                                                                                                       |
...
| abstractedHardwareEnabled    | Boolean. Set on/off the [HAL services](../reference-microservices-catalog/hal). If ON, this will install the HAL microservice                                                                                                                                                                           |
...
| routerConfig.sslProfile      | SSL profile name for router ssl configuration                                                                                                                                                                                                                                                                               |
| routerConfig.caCert          | base64 encoded CA Cert string                                                                                                                                                                                                                   |
| routerConfig.tlsCert         | base64 encoded TLS Cert string                                                                                                                                                                                                                                                             |
| routerConfig.tlsKey          | base64 encoded TLS Key string                                                                                                                                                                                                                     |
| routerConfig.saslMechanisms  | Set SASL Mechanism for router connections. "EXTERNAL"
| routerConfig.requireSsl      | Set as "yes". Only valid if routerMode is `interior`
| routerConfig.authenticatePeer| Set as "yes". Only valid if routerMode is `interior`                                                                                                                                                                                                                     |
