...
spec:
  ...
  ssh:
    ...
    port: 22
  package:
    version: 3.3.3 # provide Agent package version if you would like to deploy Agent as a deb or rpm package
    container: 
      image: ghcri.io/datasance/agent:3.3.3  # provide image in the case you would like to deploy Agent as a container
  config:
