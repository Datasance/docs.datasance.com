...
| ---------------- | ---------------- | ---------------- | ------------------ | ----------------- |
| Eclipse ioFog    | iofogctl         | v3.0.0           | potctl             | v1.3.7            |
| Eclipse ioFog    | Agent            | v3.0.1           | Agent              | v3.3.3            |
| CNCF Containerd  | Runwasi          | v0.7.0           | Runwasi            | v0.7.0            |
| Eclipse ioFog    | Controller       | v3.0.4           | Controller         | v3.4.10            |
| Eclipse ioFog    | ECN-Viewer       | v3.0.0           | ECN-Viewer         | v0.4.2           |
| Eclipse ioFog    | Router           | v3.0.0           | Router             | v3.3.0            |
| RedHat Skupper   | Skupper-Router   | v3.3.0           | Router             | v3.3.0            |
| Eclipse ioFog    | Proxy            | v3.0.0           | Proxy              | v3.1.2            |
| Eclipse ioFog    | Operator         | v3.2.0           | Operator           | v3.1.18           |
| Eclipse ioFog    | Port Manager     | v3.0.0           | Port Manager       | v3.1.7            |
| Eclipse ioFog    | HAL              | v1.0.0           | HAL                | v1.1.0            |
| Eclipse ioFog    | RESTBLUE         | v0.1             | RESTBLUE           | v1.0.0            |
| Eclipse ioFog    | iofog-go-sdk     | v3.3.0           | iofog-go-sdk       | v3.4.17           |
