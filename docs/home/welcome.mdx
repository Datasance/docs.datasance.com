---
title: Welcome to Datasance PoT - Edge Computing Platform
description: Datasance PoT is the Enterprise Open Source Fog and Distributed Edge Computing Platform. Securely deploy, manage, and scale containerized workloads across thousands of heterogeneous far-edge and IoT environments.
keywords: [datasance, pot, edge computing, edgeops, fog computing, distributed edge, kubernetes edge, iofog, edge microservices]
slug: /
---
...
| ---------------- | ---------------- | ---------------- | ------------------ | ----------------- |
| Eclipse ioFog    | iofogctl         | v3.0.0           | potctl             | v1.4.8            |
| Eclipse ioFog    | Agent            | v3.0.1           | Agent              | v3.5.5            |
| CNCF Containerd  | Runwasi          | v0.7.0           | Runwasi            | v0.7.0            |
| Eclipse ioFog    | Controller       | v3.0.4           | Controller         | v3.5.10            |
| Eclipse ioFog    | ECN-Viewer       | v3.0.0           | ECN-Viewer         | v1.2.3           |
| Eclipse ioFog    | Router           | v3.0.0           | Router             | v3.5.2            |
| RedHat Skupper   | Skupper-Router   | v3.4.0           | Router             | v3.5.2            |
| RedHat Skupper   | Router-Adaptor   | v2.0.1           | Router-Adaptor     | v3.5.2            |
| Eclipse ioFog    | Operator         | v3.2.0           | Operator           | v3.5.4          |
| Eclipse ioFog    | HAL              | v1.0.0           | HAL                | v1.1.0            |
| Eclipse ioFog    | RESTBLUE         | v0.1             | RESTBLUE           | v1.0.0            |
| Eclipse ioFog    | iofog-go-sdk     | v3.3.0           | iofog-go-sdk       | v3.5.2           |
