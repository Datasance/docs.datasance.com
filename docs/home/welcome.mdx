...
| ---------------- | ---------------- | ---------------- | ------------------ | ----------------- |
| Eclipse ioFog    | iofogctl         | v3.0.0           | potctl             | v1.3.6            |
| Eclipse ioFog    | Agent            | v3.0.1           | Agent              | v3.3.2            |
| CNCF Containerd  | Runwasi          | v0.7.0           | Runwasi            | v0.7.0            |
| Eclipse ioFog    | Controller       | v3.0.4           | Controller         | v3.4.9            |
| Eclipse ioFog    | ECN-Viewer       | v3.0.0           | ECN-Viewer         | v0.3.13           |
| Eclipse ioFog    | Router           | v3.0.0           | Router             | v3.2.5            |
| RedHat Skupper   | Skupper-Router   | v3.1.0           | Router             | v3.2.5            |
| Eclipse ioFog    | Proxy            | v3.0.0           | Proxy              | v3.1.1            |
| Eclipse ioFog    | Operator         | v3.2.0           | Operator           | v3.4.14           |
| Eclipse ioFog    | Port Manager     | v3.0.0           | Port Manager       | v3.1.6            |
| Eclipse ioFog    | HAL              | v1.0.0           | HAL                | v1.1.0            |
| Eclipse ioFog    | RESTBLUE         | v0.1             | RESTBLUE           | v1.0.0            |
| Eclipse ioFog    | iofog-go-sdk     | v3.3.0           | iofog-go-sdk       | v3.4.16           |
