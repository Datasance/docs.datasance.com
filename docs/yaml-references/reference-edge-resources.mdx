---
title: Edge Resources YAML Specification - potctl Reference
description: YAML specification for Edge Resources in Datasance PoT. Define interfaces for hardware and sensors connected to edge nodes.
keywords: [edge resources, hardware interface, sensor integration, potctl, yaml reference, datasance pot, edge computing, peripheral integration]
---
...
please see [Edge Resources](/v3.7.3/agent-management/edge-resources).
...
| display           | Information about how to display the attached Edge Resource in EdgeOps Console                                                                                         |
