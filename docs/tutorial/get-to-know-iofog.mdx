...
72fd11ff5d8d        ghcr.io/datasance/controller:3.4.10                         "node /usr/local/lib…"   14 minutes ago      Up 14 minutes       0.0.0.0:51121->51121/tcp, 0.0.0.0:8008->80/tcp                                      iofog-controller
```
...
:::info[Learn more Agent commands]
