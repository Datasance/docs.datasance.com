...
Here we'll see how to remotely debug our Agent. This assumes we have an IntelliJ IDEA IDE up and running, and have already imported the <a href="https://github.com/Datasance/Agent.git">Datasance/Agent github repository</a> project we are going to debug.
...
<aside class="notifications contribute">
  ...
  <a href="https://github.com/Datasance/docs.datasance.com/edit/main/docs/reference-agent/debugging.md"
    target="_blank">
