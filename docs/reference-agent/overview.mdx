---
title: Agent Overview - Reference
description: Overview of the Agent component in Datasance PoT. Learn how agents manage microservices on edge nodes in an Edge Compute Network.
keywords: [agent overview, edge compute network, ecn, datasance pot, edge node management, microservice orchestration]
---
...
:::info[Learn more about microservices]
