...
* [edgelet auth revoke](/edgelet/cli/edgelet_auth_revoke)	 - Revoke an auth token
* [edgelet auth tokens](/edgelet/cli/edgelet_auth_tokens)	 - List auth tokens
* [edgelet auth whoami](/edgelet/cli/edgelet_auth_whoami)	 - Show current auth identity
