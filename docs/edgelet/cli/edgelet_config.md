...
* [edgelet config cert](/edgelet/cli/edgelet_config_cert)	 - Install controller CA certificate
* [edgelet config switch](/edgelet/cli/edgelet_config_switch)	 - Switch configuration profile
